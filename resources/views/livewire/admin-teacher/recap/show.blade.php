                ...
                <tbody>
                  @foreach ($quizStudents as $quizStudent)
                    <tr>
                      ...
                      @if ($quiz->quiz_type == 'ES')
                        <td>
                          {{-- {{ $quizStudent->student->id }} --}}
                          <button wire:click='showEssayModal({{ $quizStudent->student->id }})' class="badge bg-primary"
                            data-bs-toggle="modal" data-bs-target="#showModal" style="cursor: pointer">
                            Review
                          </button>
                        </td>
                      @endif
