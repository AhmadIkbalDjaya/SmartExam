    ...
    <tbody>
      @foreach ($schools as $school)
        <tr>
          ...
          <td>
            <button style=" border: none;background: none; padding: 0">
              <span wire:click="edit({{ $school->id }})" class="badge text-bg-warning px-4" data-bs-toggle="modal" data-bs-target="#editModal">
                Edit
              </span>
            </button>
            <button style=" border: none;background: none; padding: 0">
              <span wire:click="delete({{ $school->id }})" class="badge text-bg-danger" data-bs-toggle="modal" data-bs-target="#deleteModal">
                Delete
              </span>
            </button>
          </td>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="mb-3">
              <label for="exampleFormControlInput1" class="form-label">Nama Sekolah</label>
              <input type="text" wire:model="school_name" name="school_name" id="exampleFormControlInput1"
                class="form-control @error('school_name') is-invalid @enderror" />
              @error('school_name')
                <div class="invalid-feedback">
                  {{ $message }}
            ...
            <select wire:model="school_category" name="school_category"
              class="form-select @error('school_category') is-invalid @enderror" aria-label="Default select example">
              <option hidden>Kategori</option>
              <option value="SMP">SMP</option>
              <option value="SMA">SMA</option>
            </select>
  ...
  <div wire:ignore.self class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tidak</button>
          <button type="submit" wire:click='destroy({{ $school_id }})' class="btn btn-primary">Ya</button>
        </div>
      </div>
    </div>
  </div>
